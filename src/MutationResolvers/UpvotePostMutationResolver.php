...
class UpvotePostMutationResolver extends AbstractUpvoteOrUndoUpvotePostMutationResolver
{
    ...
    protected function update($form_data)
    {
        ...
        if (in_array($target_id, $opposite)) {
            ...
            /**
             * @var DownvotePostMutationResolver
             */
            $opposite_instance = $instanceManager->getInstance(DownvotePostMutationResolver::class);
