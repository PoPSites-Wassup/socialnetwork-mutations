...
class DownvotePostMutationResolver extends AbstractDownvoteOrUndoDownvotePostMutationResolver
{
    ...
    protected function update($form_data)
    {
        ...
        if (in_array($target_id, $opposite)) {
            ...
            /**
             * @var UpvotePostMutationResolver
             */
            $opposite_instance = $instanceManager->getInstance(UpvotePostMutationResolver::class);
